  ...
  return (
    <div className="grid md:grid-cols-2 bg-red-500 stack md:stack-none text-gray-100 md:text-white">
      <div className="md:p-7 py-4 px-6 self-center area z-10 md:z-auto md:area-none">
        <h1 className="md:text-2xl font-bold mb-2 md:mb-4">About Me!</h1>
        <h2 className="xl:text-lg text-sm mb-2">
          I am <span className="font-semibold">Ogunmola Emmanuel</span>, A
          Frontend Developer;
        </h2>
        <p className="xl:text-lg text-sm mb-2 leading-loose xl:w-[35rem]">
          <Link
        ...
        <p className="xl:text-lg text-sm xl:w-[35rem]">
